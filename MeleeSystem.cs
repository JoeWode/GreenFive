...
public class MeleeSystem : MonoBehaviour {
	...
	This script is meant to be attached to a null object positioned slightly in front of the FPSController's secondary camera. It needs to be outside the FPSController's collider.
	...
	*/
	...
	public GameObject impactParticles; //Reference to the particle system prefab instantiated on impact with a collider.
	public AudioClip hitSound; //Reference to the audio clip used when the raycast hits a collider.
...
is being struck. I aslo intend to add the ability to instantiate decals at the raycast hit so that each strike leaves a mark. These will also differ according to 'material'.
*/