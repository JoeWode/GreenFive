...
public class weaponSwitch : MonoBehaviour {
	...
	*/
	...
	void Update () {
		...
		if (Input.GetKeyUp(KeyCode.Alpha1) && Weapon01.SetActive(true)) {
		...
		if (Input.GetKeyUp(KeyCode.Alpha2) && Weapon02.SetActive(true)) {
			Weapon02.SetActive(false);
			Weapon01.SetActive(false);
			Weapon03.SetActive(false);
		} else {
		...
		if (Input.GetKeyUp(KeyCode.Alpha3) && Weapon03.SetActive(true)) {
			Weapon03.SetActive(false);
			Weapon02.SetActive(false);
			Weapon01.SetActive(false);
		} else {
